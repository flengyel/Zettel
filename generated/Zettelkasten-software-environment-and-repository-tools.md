...
Last checked: 2026-07-02T22:42:00-04:00
...
| `Makefile` | optional GNU Make automation for generating and publishing the software environment Wiki page | present |
| `scripts/publish-software-environment.ps1` | PowerShell automation for generating, copying, committing, and pushing the generated software environment Wiki page | present |
| `scripts/publish-software-environment.cmd` | Windows command wrapper for the software environment Wiki publishing script | present |
