...
-   Filenames have the format `ID.md` in my implementation, where the format of `ID` is defined in [ID format](https://github.com/flengyel/Zettel/wiki/0.1.0.22.0305.1829-ID-Format).
